...
import ServiceForm from './common/ServiceForm'; // Import reusable form

const API_URL = 'http://127.0.0.1:8000/api/members';  // Base API URL
...
const AdminMembers = () => {
  ...
  return (
    <div>
      ...
      <ServiceForm initialData={editingMember || {}} onSubmit={handleFormSubmit} />
